...
class Director(models.model):
    ...
    nom = models.CharField(max_lenght=50)
...
class Actor(models.Model):
    ...
    nombre = models.CharField(max_length=50)
    fecha_nto = models.DateField()
class Proyecta(models.model):
    id_sala = models.IntegerField(Sala, on_delete=models.CASCADE)
    id_pelicula = models.IntegerField(Pelicula, on_delete=models.CASCADE)
    fecha = models.DateField().primary_key
    hora = models.TimeField().primary_key
class Participa(models.model):
    id_pelicula = models.IntegerField(Pelicula, on_delete=models.CASCADE)
    id_actor = models.IntegerField(Actor, on_delete=models.CASCADE)