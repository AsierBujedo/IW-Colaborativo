...
urlpatterns = [
    ...
    path('cines/<int:pk>', views.CineV.as_view(), name='details_cine'),
    ...
    path('salas/<int:pk>', views.SalaV.as_view(), name='details_sala'),
    ...
    path('peliculas/<int:pk>', views.PeliculaV.as_view(), name='details_pelicula'),
